...
Also you need to install one of either
`sorl-thumbnail` or `easy-thumbnails` depending on which thumbnail engine you want to use.

Additional dependencies you must install
